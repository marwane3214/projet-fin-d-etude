...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{diagrams_uml/diagrams_uml/diagramme_classe.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{diagrams_uml/diagrams_uml/sequence_liquidation_saga.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{diagrams_uml/diagrams_uml/sequence_achat_point.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{diagrams_uml/diagrams_uml/sequence_reversion_pension.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{diagrams_uml/diagrams_uml/sequence_ai.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{diagrams_uml/diagrams_uml/sequence_notification_logs.png}
...
\rowcolor{cimrblue!5} \includegraphics[height=1.2cm]{logoss/logos/java.png} & \textbf{Java 17 LTS} : Version LTS à long terme assurant robustesse, typage statique fort et fonctionnalités modernes (records, pattern matching). \\
\rowcolor{white} \includegraphics[height=1.2cm]{logoss/logos/spring_boot.png} & \textbf{Spring Boot 3.2.3 \& Spring Cloud} : Socle applicatif d'entreprise gérant l'auto-configuration, Spring Data JPA, Spring Security (JWT) et la Gateway d'accès. \\
\rowcolor{cimrblue!5} \includegraphics[height=1.2cm]{logoss/logos/postgresql.png} & \textbf{PostgreSQL 15 \& Flyway} : SGBDR robuste garantissant la conformité ACID. Une base par service, versionnée automatiquement avec Flyway. \\
\rowcolor{white} \includegraphics[height=1.2cm]{logoss/logos/kafka.png} & \textbf{Apache Kafka 7.5.3} : Bus d'événements distribué pour la communication asynchrone (notifications, journalisation d'audit et transactions Saga). \\
\rowcolor{cimrblue!5} \includegraphics[height=1.2cm]{logoss/logos/python.png} & \textbf{Python 3.12, EasyOCR \& Transformers} : Moteur du service IA pour l'extraction de données de documents (EasyOCR) et l'assistance chatbot. \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{tabularx}{\textwidth}{c X}
\rowcolor{cimrblue} \textcolor{white}{\textbf{Logo}} & \textcolor{white}{\textbf{Technologie, Version \& Rôle dans le Projet}} \\
\rowcolor{cimrblue!5} \includegraphics[height=1.0cm]{logoss/logos/react.png} & \textbf{React 19.2.4} : Bibliothèque déclarative basée composants réutilisables assurant un rendu rapide et une structure modulaire. \\
\rowcolor{white} \includegraphics[height=1.0cm]{logoss/logos/typescript.png} & \textbf{TypeScript 5.9} : Version typée de JavaScript prévenant les erreurs de développement et facilitant la maintenance du code. \\
\rowcolor{cimrblue!5} \includegraphics[height=1.0cm]{logoss/logos/vite.png} & \textbf{Vite 8.0.0 \& React Router} : Outil de compilation ultra-rapide et routeur déclaratif pour une navigation fluide sans rechargement. \\
\rowcolor{white} \includegraphics[height=1.0cm]{logoss/logos/tailwind.png} & \textbf{Tailwind CSS} : Framework CSS utility-first pour un design réactif (responsive), esthétique et uniforme. \\
\rowcolor{cimrblue!5} \includegraphics[height=1.0cm]{logoss/logos/tanstack.png} & \textbf{TanStack Query \& Axios} : Gestion avancée du cache de données côté client et communication HTTP sécurisée (intercepteurs de tokens). \\
\rowcolor{white} \includegraphics[height=1.0cm]{logoss/logos/zod.png} & \textbf{Zod \& React Hook Form} : Validation stricte des formulaires par schémas et gestion optimisée de la saisie utilisateur. \\
\bottomrule
\end{tabularx}
\end{table}
...
\rowcolor{cimrblue!5} \includegraphics[height=1.0cm]{logoss/logos/docker.png} & \textbf{Docker \& Docker Compose} : Conteneurisation multi-stage (JRE minimale) de chaque service et orchestration globale en local (12 conteneurs). \\
\rowcolor{white} \includegraphics[height=1.0cm]{logoss/logos/github.png} & \textbf{Git \& GitHub} : Outil de suivi de versions et plateforme de stockage collaboratif pour le code source. \\
\bottomrule
\end{tabularx}
\end{table}
